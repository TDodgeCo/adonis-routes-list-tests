...
const ResolveAssetsPlugin = require('./ResolveAssetsPlugin');
...
|--------------------------------------------------------------------------
|
| The output path for writing the compiled files. 
/ This is the directory where compiled assets will be stored
|
*/
...
|
*/
Encore.setPublicPath('/public/assets')
...
Encore.copyFiles({
  ...
  to: 'images/[path].[hash:8][name].[ext]',
})
Encore.copyFiles({ 
  from: './resources/views',
  to: 'html/[path]/[name].html'
})
/*
|--------------------------------------------------------------------------
| Split shared code
...
/*
|--------------------------------------------------------------------------
| Enable {{ asset('*) }} resolution in html files
|--------------------------------------------------------------------------
|
| Enable assets versioning to leverage lifetime browser and CDN cache
|
*/
Encore.addPlugin(new ResolveAssetsPlugin())
/*
|--------------------------------------------------------------------------
...
|--------------------------------------------------------------------------
|
| Comment the following line of code to disable support for
| TS - will also need to change the file extension to .js in Encore.addEntry (line 57)
|
*/
